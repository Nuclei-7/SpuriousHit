<%-- 
    Document   : profile
    Created on : 28-Mar-2024, 12:53:57 am
    Author     : Mr Kalwar
--%>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="profile.jsp">Programming Language</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="aboutus.jsp"><span class="fa fa-address-book-o"></span>About Us</a>
                </li>
                <li class="nav-item">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                  ...
                  <div class="container" style="border-radius: 50%; overflow: hidden; height: 150px; width: 150px; position: relative;">
                    <img src="pics/<%= user.getProfile()%>" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); object-fit: cover; width: 100%; height: 100%;">
                    
                </div>
                    <h5 class="modal-title" style="text-align: center;"><%= user.getName()%></h5>
...
<script>
    $(document).ready(function(){
        if (!localStorage.getItem("underDev")) {
            swal({
                text: "The website is Under Development! Bugs may Encounter"
            });
            localStorage.setItem("underDev", true);
        }
    });
</script>
